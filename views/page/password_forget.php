    ...
    <div class="row">
        <div class="col-md-6 offset-md-3">
            <div class="card py-5 px-3 my-3">
                ...
                <form id="password-forget-form" method="post">
                    ...
                    <div class="text-center mt-5">
                        <button id="password-forget-btn" type="submit" class="btn btn-primary w-100">
                            送信
                            <div id="password-forget-btn-spinner" class="spinner-border spinner-border-sm text-light d-none" role="status">
                ...
                <div id="password-forget-completion-msg" class="text-center d-none">
                    <h4>送信完了</h4>
...
<script src="/js/page/password_forget.js"></script>
